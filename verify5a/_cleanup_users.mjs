...
const t = (data?.users ?? []).filter((u) => u.email?.startsWith("t5a_"));
...
console.log("deleted", t.length, "| remaining t5a_ users:", (after?.users ?? []).filter((u) => u.email?.startsWith("t5a_")).length);
