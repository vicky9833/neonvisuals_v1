...
const t = (data?.users ?? []).filter((u) => u.email?.startsWith("t7a_"));
...
console.log("deleted", t.length, "| remaining t7a_ users:", (after?.users ?? []).filter((u) => u.email?.startsWith("t7a_")).length);
