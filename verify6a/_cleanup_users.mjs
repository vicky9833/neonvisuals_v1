...
const t = (data?.users ?? []).filter((u) => u.email?.startsWith("t6a_"));
...
console.log("deleted", t.length, "| remaining t6a_ users:", (after?.users ?? []).filter((u) => u.email?.startsWith("t6a_")).length);
